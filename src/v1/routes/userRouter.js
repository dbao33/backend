...
import { createUser, loginUser, updateUser, deleteUser, getAllUser,getDetailsUser } from '../controllers/userController.js'
...
router.route('/get-details-user/:id').get(getDetailsUser)
